...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="EmployeeName" CssClass="col-md-2 control-label">Employee Name</asp:Label>
            <div class="col-md-10">
        ...
        <div class="form-group">
            <asp:Label runat="server" AssociatedControlID="Hospital" CssClass="col-md-2 control-label">Hospital</asp:Label>
            <div class="col-md-10">
                <asp:DropDownList runat="server" ID="ddlHospital" CssClass="form-control" AppendDataBoundItems="true" OnLoad="ddlHospitalName_Load">  
                    <asp:ListItem Text="--Select Hospital--" Value="0" />
                </asp:DropDownList>
                <asp:CompareValidator ControlToValidate="EmpDept" ID="CompareValidator1"
